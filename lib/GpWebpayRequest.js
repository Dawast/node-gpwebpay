...
exports.GpWebpayRequestCurrency = void 0;
const crypto_1 = __importDefault(require("crypto"));
var GpWebpayRequestCurrency;
(function (GpWebpayRequestCurrency) {
    GpWebpayRequestCurrency["CZK"] = "203";
})(GpWebpayRequestCurrency || (GpWebpayRequestCurrency = {}));
exports.GpWebpayRequestCurrency = GpWebpayRequestCurrency;
var GpWebpayRequestPaymentMethod;
(function (GpWebpayRequestPaymentMethod) {
    GpWebpayRequestPaymentMethod["APPLE_PAY"] = "APAY";
    GpWebpayRequestPaymentMethod["GOOGLE_PAY"] = "GPAY";
    GpWebpayRequestPaymentMethod["CART"] = "CRD";
    GpWebpayRequestPaymentMethod["MASTERPASS"] = "MPS";
    GpWebpayRequestPaymentMethod["MASTERCARD_MOBILE"] = "MCM";
})(GpWebpayRequestPaymentMethod || (GpWebpayRequestPaymentMethod = {}));
class GpWebpayRequest {
    constructor(merchantNumber, operation, orderNumber, amount, currency, url) {
        this.depositFlag = 1;
    ...
    sign(privateKey, privateKeyPass) {
...
exports.default = GpWebpayRequest;
